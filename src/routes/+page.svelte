...
<div class="mt-6 flex hidden items-center justify-end gap-x-6">
				...
				<div class="space-y-5">
					...
					<div class="flex justify-end gap-x-3">
						<button
							...
							disabled={isLoading}
							class="cursor-pointer rounded-md px-3 py-2 text-sm font-semibold text-primary-dark shadow-xs outline-1 outline-primary-dark focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-dark"
						>
						...
						<button
							...
							disabled={isLoading}
							class="cursor-pointer rounded-md bg-primary px-3 py-2 text-sm font-semibold text-primary-dark shadow-xs hover:bg-primary/80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
						>
